...
const BlackBoxWithStats: FC<BlackBoxWithStatsProps> = ({ className, stats }) => {
  return (
    <div
      className={`hidden md:block absolute bottom-0 right-0 bg-black w-full md:w-auto md:min-w-[800px] lg:min-w-[500px] xl:min-w-[550px] 2xl:min-w-[600px] ${className}`}
    >
      <div
        className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 p-6 md:p-16 lg:p-10 xl:p-12 2xl:p-14"
      >
