  ...
  useEffect(() => {
    ...
    function initMap() {
      ...
      var myMap = new ymaps.Map("yandexMap", {
        center: [55.752, 37.5926], // Москва, Арбат
        zoom: 15,
      ...
      var myPlacemark = new ymaps.Placemark(
        [55.752, 37.5926],
        {
          hintContent: "СИБКОМПЛЕКТ",
          balloonContent: "ул. Арбат, 26, Москва",
        },
        {
          // Опции метки
      ...
      // Дополнительная настройка оформления карты
      ...
      <div className="container mx-auto px-4 lg:px-16 2xl:px-24">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-12">
          ...
          <div className="w-full md:w-auto">
            ...
            <div className="md:hidden w-full space-y-4">
              {['Каталог', 'Проекты', 'О компании', 'О производстве', 'Вакансии', 'Контакты'].map((item) => (
            ...
            <div className="hidden md:grid grid-cols-4 gap-8">
              {['Каталог', 'Проекты', 'О компании', 'О производстве'].map((item) => (
        ...
        <div className="border-t border-white/30 pt-12 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-8 md:flex md:flex-col md:justify-between">
              {[
                { title: 'Отдел продаж', phone: '8 (880) 990-00-00', email: 'test@mail.ru' },
                { title: 'Офис компании', phone: '8 (880) 990-00-00', email: 'test@mail.ru' },
              ].map((block, index) => (
                <div key={index}>
            ...
            <div className="space-y-8 md:flex md:flex-col md:justify-between">
              {[
                { title: 'Конструкторский отдел', phone: '8 (880) 990-00-00', email: 'test@mail.ru' },
                { title: 'Сервисная служба', phone: '8 (880) 990-00-00', email: 'test@mail.ru' },
              ].map((block, index) => (
                <div key={index}>
                  <p className="text-white/80 mb-4">• {block.title}</p>
                  <div className="flex items-center mb-3">
            ...
            <div>
              ...
              <div id="yandexMap" className="w-full h-[220px] mt-4"></div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/30 pt-8">
          ...
          <div className="md:hidden space-y-4">
            <p className="text-white/80 text-sm">© {new Date().getFullYear()}г. Все права защищены.</p>
            <a href="#" className="block text-white/80 text-sm hover:text-white/70">
