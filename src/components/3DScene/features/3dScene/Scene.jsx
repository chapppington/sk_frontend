...
export default function Scene() {
  ...
  // Only initialize stats in development mode
  useEffect(() => {
  ...
  useFrame(({ clock }) => {
    ...
    // Update stats only in development mode
    if (process.env.NODE_ENV === "development" && statsRef.current) {
  ...
  useEffect(() => {
    if (isFirstRender.current) {
      ...
      tl.to(
        ...
        .to(
          customShaderTest.uniforms.uFluctuationFrequency,
          {
            value: 1,
            duration: 0,
            delay: 0,
        ...
        .to(
          customShaderTest.uniforms.uFluctuationAmplitude,
          {
            value: 1,
            duration: 0,
            delay: 0,
        ...
        .to(
          customShaderTest.uniforms.uColor.value,
          {
            x: 1,
            y: 1,
            z: 1,
