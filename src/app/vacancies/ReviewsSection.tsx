          ...
          >
            {reviews.map((review, index) => (
              <SwiperSlide key={index}>
                <div className="flex flex-col p-8 border border-white/40 rounded-xl shadow-md h-full bg-white/5">
                  {/* Top section: image + name/position (row on desktop, column on mobile) */}
