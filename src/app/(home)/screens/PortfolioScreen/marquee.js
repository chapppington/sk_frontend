...
export function setupMarqueeAnimation() {
  ...
  // Create a new timeline that's independent of scroll
  const tl = horizontalLoop(marqueeItems, {
    repeat: -1,
    paddingRight: 30,
    speed: 0.5, // Slower speed for better readability
  });

  // Store the timeline on the window for debugging
  window.marqueeTimeline = tl;
}
