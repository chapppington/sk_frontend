...
const Section17Question = ({ value, onChange }: QuestionProps) => {
  const options = ["100", "160", "250", "400", "630", "1000"];

  return (
    <Dropdown title="17 · Токи фидеров, А" defaultOpen={true}>
...
export default Section17Question;
