...
const ImplementationQuestion = ({ value, onChange }: QuestionProps) => {
  const options = ["Проходная", "Тупиковая"];

  return (
    <Dropdown title="02 · Исполнение КТП" defaultOpen={true}>
      <div className="space-y-4">
        {options.map((impl, index) => (
...
export default ImplementationQuestion;
